...
$router->get('/api/library/{id}/friends-reading', 'UserBookController@getFriendsReading');
...
$router->get('/api/ratings/{book_id}',      'ReviewController@getRating');
...
$router->get('/api/posts/my/stats',         'PostController@getMyStats');
